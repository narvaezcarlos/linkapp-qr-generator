...
const AccountButton = () => {
    ...
    return (
        <a href='https://www.linkapp.com.co/login' className='db w-90 w-50-l mv4 pa3 bn br3 bg-action-primary pointer hover-shadow-3 white center tc no-underline' onClick={() => setAccountLoading('')}>
