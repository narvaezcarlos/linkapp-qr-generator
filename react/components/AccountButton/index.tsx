...
const AccountButton = () => {
    ...
    return (
        <a href='https://jpdev--ventadirectanewqa.myvtex.com/account' className='db w-90 w-50-l mv4 pa4 bn br3 bg-action-primary pointer hover-shadow-3 white center tc no-underline' onClick={() => setAccountLoading('')}>
